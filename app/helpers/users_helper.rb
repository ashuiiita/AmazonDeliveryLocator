...
module UsersHelper
	...
	def self.getLocationData(user_latitude,user_longitude,delivery_center_latitude,delivery_center_longitude)
		puts "https://maps.googleapis.com/maps/api/distancematrix/json?origins="+user_latitude.to_s+","+user_longitude.to_s+"&destinations="+delivery_center_latitude.to_s+","+delivery_center_longitude.to_s+"&key=AIzaSyBVKykw5J7k44ve9GIC0mlqWwm0XZjTPWw"
